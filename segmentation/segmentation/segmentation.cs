...
namespace segmentation
{
    ...
    public class Segmentation
    {
        ...
        public List<string> SegMM(string inputStr, ref List<string> wordList, bool leftToRight, int maxLength)
        {
            //指定词典不能为空
            if (wordList == null)
                return null;
        ...
        /// <param name="leftToRight">true为从左到右分词，false为从右到左分词</param>
        /// <returns>储存了分词结果的字符串数组</returns>
        public List<string> SegMM(string inputStr, ref List<string> wordList, bool leftToRight)
        {
        ...
        /// <param name="wordList">词典</param>
        /// <returns>储存了分词结果的字符串数组</returns>
        public List<string> SegMMLeftToRight(string inputStr, ref List<string> wordList)
        {
        ...
        /// <param name="wordList">词典</param>
        /// <returns>储存了分词结果的字符串数组</returns>
        public List<string> SegMMRightToLeft(string inputStr, ref List<string> wordList)
        {
